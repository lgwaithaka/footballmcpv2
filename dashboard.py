...
<div class="tab-pane active" id="tab-predictions">
  <div class="filters">
    ...
    <button class="filter-btn" data-filter="Spain">La Liga / Spain</button>
...
function getFiltered(){
  let d=[...allFixtures];
  if(currentFilter!=='all') d=d.filter(f=>f.country===currentFilter||f.league.includes(currentFilter)||f.country.includes(currentFilter));
