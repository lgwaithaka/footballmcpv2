...
def _to_scheduled_match(m: dict, league_name: str, country: str) -> Optional[ScheduledMatch]:
    ...
    Returns None for any fixture with unconfirmed or missing team names.
    """
    try:
        ...
        # Safely extract team names — API may return None explicitly for TBD teams
        ...
        # Skip if either team is unconfirmed (TBD / empty)
        ...
        return ScheduledMatch(
            ...
            lines_b=None,   # xG/form model used for these fixtures
        )
    except Exception as e:
        print(f"[live_schedule] Skipping match due to error: {e}")
        return None
